...
class TutorialView extends GLSurfaceView 
{
	...
	// Full 32-bits color for the surface
	protected int redSize = 8;
	protected int greenSize = 8;
	protected int blueSize = 8;
	protected int alphaSize = 8;

	// 16-bits for depth buffer which is need
	// to make objects displayed in the right order
	protected int depthSize = 16;

	// Enabling Anti Aliasing (4x)
	...
	public TutorialView(Context ctx)
	{
		...
		/*
			EGL is a very important part of OpenGL ES and acts as the interface 
			between the windowing system and OpenGL ES drawing commands
		*/
